						...
						<tbody>
							@foreach ($posts as $key => $row)
								<tr>
									...
									<td>
										<a href="{{ route('author.posts.edit',$row->id) }}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a> |
										<a href="{{ route('author.posts.edit',$row->id) }}" class="btn btn-info btn-xs"><i class="fa fa-edit"></i></a> |
