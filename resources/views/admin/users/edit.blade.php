						...
						<div class="box-body">
							<div class="row">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" value="{{ $user->username }}" class="form-control" name="username" id="username" placeholder="Enter Username">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" value="{{ $user->phone }}" class="form-control" name="phone" id="phone" placeholder="Enter Phone">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-md-5">
											<div class="form-group">
												...
												<input type="text" value="{{ $user->about }}" class="form-control" name="about" id="about" placeholder="Enter About">
											</div>
										</div>
										<div class="col-md-2">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" name="status" id="status" {{ $row->status==1?'checked':'' }}>&nbsp;Publish
												</label>
											</div>
										</div>
									</div>
								...
								<div class="col-md-2">
									...
									<img src="{{ $user->image==''?asset('images/noimage.jpg'):asset('uploads/user/'.$user->image) }}" alt="" 
						...
						<div class="box-footer">
							<div class="row">
								<div class="col-md-2 col-md-offset-5">
									...
									<a href="{{ route('admin.users.index') }}" class="btn btn-warning btn-sm pull-right">Back</a>
								</div>
							</div>
						</div>
					</form>
